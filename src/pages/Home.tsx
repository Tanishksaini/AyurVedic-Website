...
const heroSlides = [
  {
    image: "https://images.unsplash.com/photo-1545205597-3d9d02c29597?auto=format&fit=crop&w=2000&q=80",
            ...
            {[
              {
                ...
                price: "$24.99",
                rating: 5,
                desc: "Organic stress relief and vitality boost"
              },
              {
                ...
                price: "$19.99",
                rating: 5,
                desc: "Traditional digestive wellness formula"
              },
              {
                ...
                price: "$29.99",
                rating: 5,
                desc: "Nourishing blend for healthy hair"
              }
            ].map((product, index) => (
              <div 
                key={index} 
              ...
              >
                ...
                <div className="p-6">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="text-lg font-medium text-Mehaai-primary">{product.price}</span>
                  </div>
                  <p className="text-Mehaai-dark/80 mb-4">{product.desc}</p>
                  <div className="flex items-center justify-between">
                    ...
                    <button className="bg-Mehaai-primary text-white px-4 py-2 rounded-full hover:bg-Mehaai-accent transition-colors duration-300">
                      Add to Cart
                    </button>
                  </div>
                </div>
